...
public class Visitors extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        String path = "E:\\Java_Projects\\LIBRARIES\\opencv_4_5_5\\sources\\data\\haarcascades\\";
        ...
        for (Rect r: faces.toList()) {
           Imgproc.rectangle(img, new Point(r.x, r.y), new Point(r.x + r.width, r.y + r.height), CvUtils.COLOR_WHITE, 1);
        }
